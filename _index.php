...
<head>
    ...
    <!-- Bootstrap Core CSS -->
    <link href="admin/old/bower_components/bootstrap/dist/css/bootstrap.min.css" rel="stylesheet">
...
<body background="admin/images/bg.png">
            ...
            <div class="col-md-4 col-md-offset-4">
                <div class="login-panel panel panel-default">
                    ...
                    <div class="panel-heading">
						<h3>CHED Asset and Resource Management System</h3>
	...
	<script type="text/javascript">
    	...
    	jQuery(document).ready(function($) {
			...
			//$.jGrowl("Hello world!");
                $.ajax({
                    url: 'admin/include/userlogin.php',
                    type: 'post',
