    ...
    <body>
        ...
        <div id="login-container">
            ...
            <h1 class="h2 text-light text-center push-top-bottom animation-slideDown">
                <i class="fa fa-cube"></i> <strong>Project: Sign Off</strong>
            </h1>
            <!-- END Login Header -->
            ...
            <div class="block animation-fadeInQuickInv">
                ...
                <!-- Login Form -->
                <form id="form-login" action="admin/" method="post" class="form-horizontal">
                    <div class="form-group">
                        <div class="col-xs-12">
                            <input type="text" id="login-email" name="login-email" class="form-control" placeholder="Your username">
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="col-xs-12">
